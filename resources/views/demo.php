...
<div class="invoice-box">
    <table class="company-details" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td colspan="3" style="font-size: 32px; font-weight: bold;text-align: center">
        ...
        <tr>
            <td colspan="3" style="text-align: center;">
                ...
                <h6 style="padding: 0;margin: 8px 0;font-size: 18px">Phone: {{ $company->phone }}</h6>
                <h6 style="padding: 0;margin: 8px 0;font-size: 12px">Website: stylehomefurniture.net </h6>
            </td>
        ...
        <table cellpadding="4px" cellspacing="0">
            ...
            @foreach($order->items as $item)
                <tr class="item heading-tow">
                    <td class="item-column">{{ $loop->iteration }}</td>
