...
<div class="invoice-box">
    <table class="company-details" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td colspan="3" style="font-size: 30px; font-weight: bold;text-align: left;color:red;">
                <!--<span class="company-name">Style Home & Furniture Inc</span> <br>-->
                <img src="{{ public_path('images/name.png') }}" style="width: 500px;" />

            </td>
            <td colspan="3" style="font-weight: bold;">
                Date: {{$order->order_date->format('m-d-y')}} <br> <span style="font-size: 15px;color:red; font-weight: bold;text-align: center" class=""> INVOICE: {{ $order->invoice_number }}</span> 
            </td>
            
        </tr>
        <tr>
            <td colspan="3" style="text-align: left;">
                <h6 style="padding: 0;margin: 8px 0;font-size: 15px">{{ $company->address }}</h6>
                <h6 style="padding: 0;margin: 8px 0;font-size: 15px">Phone:330-491-9907 | 234-322-1930 | stylehomefurniture.net </h6>
                <!--<h6 style="padding: 0;margin: 8px 0;font-size: 15px">stylehomefurniture.net </h6>-->
            </td>
            <td colspan="2" style="text-align: right;">
                <img src="{{ public_path('images/mainlogo.JPG') }}" style="width:90px;height:70px;margin-top:0;margin-right:10px" />
            </td>

        </tr>
    </table>

    <table class="information" cellpadding="4px" cellspacing="0" style="margin-bottom: 0px;margin-top:0px;font-weight: bold">
        ...
        <table cellpadding="4px" cellspacing="0">
            ...
            <tr class="item heading-tow">
                <td colspan="3" rowspan="7" style="border-left: 1px solid #a9a9a9;padding: 0; position: relative">
                    <div style="background: #363636;color: white;text-align: center; padding: 1px;position: absolute;top: 0;width: 98%">
                        AGREEMENT
                    </div>
            ...
            <tr  class="item heading-tow" style="text-transform: uppercase;font-weight: bold;color:green">
                <td>
                    Paid
                </td>
                <td>
            ...
            <tr  class="item heading-tow" style="text-transform: uppercase;font-weight: bold;color:red">
                <td>
                    Balance
                </td>
                <td>
            ...
            <tr class="item heading-tow" style="text-transform: uppercase;font-weight: bold;">
                ...
                <td style="text-transform: uppercase; font-weight: bold; border-left: 1px solid #a9a9a9;">Payment</td> <!-- Added left border here -->
                <td style="font-weight: bold; border-left: 1px solid #a9a9a9;">
                    @foreach ($order->orderPayments as $payData)
                    <span>{{ optional(optional($payData->payment)->paymentMode)->name }}</span>
                    @endforeach
                </td>
            </tr>
            <tr class="item heading-tow" style="text-transform: uppercase;font-weight: bold;">
