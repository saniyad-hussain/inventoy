<template>
    ...
    >
        <span style="display: flex">
            ...
            <CustomerAddButton @addValueSelected="addValueSelected" v-else />
        </span>
    </a-form-item>
</template>
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const addValueSelected = (value, option) => {
            console.log(value, 'added value');
            fetchProducts(value.name)
            state.orderSearchTerm = value.xid
            emit("onSuccess", value.xid);
        };
