            ...
            <a-row :gutter="16">
                ...
                <a-col :xs="24" :sm="24" :md="8" :lg="8">
                    <a-form-item
                        ...
                        name="delivery_date"
                        :help="rules.delivery_date ? rules.delivery_date.message : null"
                        :validateStatus="rules.delivery_date ? 'error' : null"
                    >
                        <DateTimePicker
                            v-if="formData.delivery_date"
                            :dateTime="formData.delivery_date"
                            @dateTimeChanged="
                                (changedDateTime) =>
                                    (formData.delivery_date = changedDateTime)
                            "
                            :disabled="editOrderDisable"
                        />
                    </a-form-item>
            ...
            <a-row :gutter="16" class="mt-30">
                ...
                <a-col :xs="24" :sm="24" :md="8" :lg="8">
                    ...
                    <a-row :gutter="16">
                        ...
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            <a-form-item
                                :label="$t('stock.pickup')"
                                name="pickup"
                                :help="rules.pickup ? rules.pickup.message : null"
                                :validateStatus="rules.pickup ? 'error' : null"
                            >
                                <a-input-number
                        ...
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            <a-form-item
                                :label="$t('stock.setup')"
                                name="setup"
                                :help="rules.setup ? rules.setup.message : null"
                                :validateStatus="rules.setup ? 'error' : null"
                            >
                                <a-input-number
                                    v-model:value="formData.setup"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('stock.setup'),
                                        ])
                    ...
                    <a-row :gutter="16" class="mt-10">
                        ...
                        <a-col :xs="12" :sm="12" :md="12" :lg="12">
                            {{ formatAmountCurrency(formData.pickup) }}
                        </a-col>
                    </a-row>
                    <a-row :gutter="16" class="mt-10">
                        <a-col :xs="12" :sm="12" :md="12" :lg="12">
                        ...
                        <a-col :xs="12" :sm="12" :md="12" :lg="12">
                            {{ formatAmountCurrency(formData.setup) }}
                        </a-col>
                    </a-row>
                    <a-row :gutter="16" class="mt-10">
                        <a-col :xs="12" :sm="12" :md="12" :lg="12">
        ...
        onMounted(() => {
            ...
            Promise.all([
                ...
                formData.value = {
                    ...
                    delivery_date: orderResponseData.order.delivery_date,
                    ...
                    shipping: orderResponseData.order.shipping
                        ...
                        : 0,
                    pickup: orderResponseData.order.pickup
                        ? orderResponseData.order.pickup
                        : 0,
                    setup: orderResponseData.order.setup ?
                        orderResponseData.order.setup
                        : 0,
